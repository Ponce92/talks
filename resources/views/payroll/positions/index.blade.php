...
@section('title') Cargos de empleados @endsection

@section('body')
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title" id="basic-layout-form">Cargos de empleados</h4>
                <a class="heading-elements-toggle"><i class="icon-ellipsis font-medium-3"></i></a>
                <div class="heading-elements">
                    @if(Auth::user()->hasPermission('puede_crear_cargos'))
                    <button class="btn btn-green" type="button" onclick="showCreateForm('{{ route('positions.create') }}')">
