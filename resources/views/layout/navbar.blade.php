            ...
            <ul class="nav navbar-nav">
                ...
                <li class="nav-item">
                    <a href="{{route('dashboard')}}" class="navbar-brand nav-link">
                        <img alt="..." src="../../app-assets/images/logo/robust-logo-light.png" data-expand="../../app-assets/images/logo/robust-logo-light.png" data-collapse="../../app-assets/images/logo/robust-logo-small.png" class="brand-logo">
                    </a>
                </li>
