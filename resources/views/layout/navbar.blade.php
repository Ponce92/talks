            ...
            <ul class="nav navbar-nav">
                ...
                <li class="nav-item">
                    <a href="" class="navbar-brand nav-link">
                        <img alt="logo"
                             src="{{asset('img/logo/logo_normal.png')}}"
                             data-expand="{{asset('img/logo/logo_normal.png')}}"
                             data-collapse="{{asset('img/logo/logo_small_icon.png')}}"
                            class="brand-logo"
                        >
                    </a>
...
{{--                        </a></li>--}}
                    <li class="dropdown dropdown-user nav-item">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <a href="#" class="dropdown-item"><i class="icon-head"></i> Acciones</a>
